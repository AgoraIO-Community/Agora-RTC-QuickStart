...
Join an Agora RTC channel quickly, publish local media, and subscribe to remote participants.

Use this recipe when you want a working reference for quickstart, RTC channel, audio/video, sample app.

Repository: [AgoraIO-Community/Agora-RTC-QuickStart](https://github.com/AgoraIO-Community/Agora-RTC-QuickStart)
...
```text
You are working in `AgoraIO-Community/Agora-RTC-QuickStart`. Add or adapt this sample so a developer can run the rtc quickstart end to end with Agora RTC.
